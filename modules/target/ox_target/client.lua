...
if (Config.Default.Target == "auto" and GetResourceState(resourceName) ~= "started") or (Config.Default.Target ~= "auto" and Config.Default.Target ~= resourceName) then return end
