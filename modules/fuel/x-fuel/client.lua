...
if (Config.Default.Fuel == "auto" and GetResourceState(resourceName) ~= "started") or (Config.Default.Fuel ~= "auto" and Config.Default.Fuel ~= resourceName) then return end
